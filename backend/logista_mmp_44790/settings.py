"""
Django settings for logista_mmp_44790 project.
...
ROOT_URLCONF = 'logista_mmp_44790.urls'
...
WSGI_APPLICATION = 'logista_mmp_44790.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "logista_mmp_44790 API",
    "DESCRIPTION": "API documentation for logista_mmp_44790 App",
    "VERSION": "v1",
}
